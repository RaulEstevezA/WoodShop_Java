...
public class AA5_WoodShops {
        ...
        do {
            ...
            switch (numero) {
                ...
                case 9:
                    ...
                    break;
                case 10:
                    mostrarTotalVentasEntreFechas(sede);
                    break;
                case 0:
                    salir = true;
            }
    ...
    public static void mostrarTicket(SedeCentral sede) {
        ...
        // solicitamos con verificadores las fechas, para que tnegan orden cronologico.
        Date[] fechas = Verificadores.pedirDosFechas();
        Date fechaInicio = fechas[0];
        Date fechaFin = fechas[1];


        // preguntar si una tienda o todas
        for (Tiendas tienda : sede.getTiendas()) {
    ...
    // Mostrar total de ventas por tiendas entre unas fechas
    public static void mostrarTotalVentasEntreFechas(SedeCentral sede) {
        // solicitamos con verificadores las fechas, para que tnegan orden cronologico.
        Date[] fechas = Verificadores.pedirDosFechas();
        Date fechaInicio = fechas[0];
        Date fechaFin = fechas[1];
        ...
        for (Tiendas tienda : sede.getTiendas()) {
            tienda.calcularVentasEntreFechas(fechaInicio, fechaFin);
        }
    }
}
